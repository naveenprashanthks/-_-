#Titanic Classification Task 1 - CodeAlpha
...
Supervised Machine learning Techniques: + Logic Regression Model + Plotting results + Support Vector Machine (SVM) using 3 kernels + Basic Random Forest + Plotting results. 
